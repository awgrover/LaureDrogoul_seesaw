...
{  
  ...
  numprint(temp.temperature,3); Serial.print("C ");
  Serial.print("m/s^2 ");
    numprint(lsm.accelData.x, 6); Serial.print(" "); // was accell.acceleration.x
    numprint(lsm.accelData.y, 6); Serial.print(" ");
    numprint(lsm.accelData.z, 6); Serial.print(" ");
  Serial.print("gauss ");
    numprint(mag.magnetic.x, 5); Serial.print(" ");
    numprint(mag.magnetic.y, 5); Serial.print(" ");
    numprint(mag.magnetic.z, 5); Serial.print(" ");
  Serial.print("deg/sec ");
    numprint(gyro.gyro.x, 6); Serial.print(" ");
    numprint(gyro.gyro.y, 6); Serial.print(" ");
    numprint(gyro.gyro.z, 6); Serial.print(" ");
  Serial.println();
